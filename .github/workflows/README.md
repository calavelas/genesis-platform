...
Files:
- `tars-build.yml`: runs TARS SVCS reconcile on pull requests and `main`; CASE PR handling can auto-approve/merge and optionally delete merged source branches.
